                ...
                <div class="row mt-2">
                  <div class="col-6">
                    <div class="card mb-3" style="max-width: 18rem;">
                      <div class="card-header text-bg-success"><h5>Admit Card Download</h5></div>
                      <div class="card-body">
                        <h4 class="card-title">20 September,2022</h4> 
                      </div>
                    </div>
                    <div class="card mb-3" style="max-width: 18rem;">
                      <div class="card-header text-bg-success"><h5>Admit Card Download</h5></div>
                  ...
                  <div class="col-6">
                    <div class="card mb-3" style="max-width: 18rem;">
                      <div class="card-header text-bg-success"><h5>Last Date of Payment</h5></div>
                      <div class="card-body">
                        <h4 class="card-title">25 September,2022</h4> 
                      </div>
                    </div>
